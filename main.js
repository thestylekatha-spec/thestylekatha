    ...
    function initShopUI(){
      ...
      var cart = (window.SKCart ? window.SKCart.get() : []); // {id, name, cat, price, image, qty}
      ...
      function renderCart(){
        ...
        if (window.SKCart) window.SKCart.set(cart);
      }
      ...
      // Opened from another page ("View Bag" / nav bag link)
      if (window.location.hash === '#cart') setTimeout(openCart, 60);
